...
public class Manager {
    ...
    public Manager(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            ...
            if (subscriptionManager != null) {
                ...
                subscriptionManager.addOnSubscriptionsChangedListener(context.getMainExecutor(),
        ...
        if (activeSubscriptionList != null && !activeSubscriptionList.isEmpty()) { // always at least 1
            ...
            if (firstManager != null) {
                ...
                if (firstManager.getNetworkOperatorName() != null
                    ...
                    str.append(firstManager.getNetworkOperatorName()).append(" ")
                            .append(networkGen == 0 ? "Unknown"
            ...
            if (activeSubscriptionList.size() > 1) {
                ...
                if (secondManager != null) {
                    ...
                    if (secondManager.getNetworkOperatorName() != null
                        ...
                        str.append(" | ").append(secondManager.getNetworkOperatorName()).append(" ")
                                .append(networkGen == 0 ? "Unknown"
                                        : (networkGen < 0 ? "No service"
                                                : networkGen + "G" + (networkGen == 5 ? (nrSa ? " SA" : " NSA") : "")));
                } else
    ...
    public SIMData getSimNetworkData(TelephonyManager telephony) {
                ...
                switch (baseCell.getCellConnectionStatus()) {
                    case CellInfo.CONNECTION_PRIMARY_SERVING:
                        if (baseCell instanceof CellInfoGsm) {
                            ...
                            if (data.getPrimaryCell() == null && getSimNetworkGen(telephony) == 2
                            ...
                            data.setPrimaryCell(cdmaCellData);
                                ...
                                && baseCell instanceof CellInfoTdscdma) {
        ...
        if (data.getPrimaryCell() != null) {
            switch (data.getNetworkGen()) {
                ...
                case 3: // filter out bands
                    if (data.getPrimaryCell() instanceof CdmaCellData
                            || data.getPrimaryCell() instanceof TdscdmaCellData) {
                        for (CellData cellData : data.getActiveCells()) {
                            if (cellData != data.getPrimaryCell())
                                data.removeActiveCell(cellData);
                        }
        ...
        if (data.getPrimaryCell() != null && data.getPrimaryCell() instanceof LteCellData) {
            ...
            nrCells.sort((a, b) -> Integer.compare(b.getBasicCellData().getFrequency(),
                    a.getBasicCellData().getFrequency()));
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                ...
                signalStrengths.sort(Comparator.comparingInt(CellSignalStrengthNr::getSsRsrp)); // -110dBm -> -99dBm ->
                                                                                                // -78dBm
                ...
                for (int i = 0; i < limit; i++) {
                    ...
                    if (nrCell.getProcessedSignal() == CELL_INFO_UNAVAILABLE
                            && ssNr.getSsRsrp() != CELL_INFO_UNAVAILABLE) {
        ...
        switch (simId) {
            case 0:
                ...
                if (simData != null && simData.getPrimaryCell() != null) {
                    ...
                    saveEvent(EventTypes.MOBILE_BAND_CHANGED, 0,
                            (primaryCell instanceof NrCellData ? "N" : "B")
                                    + (primaryCell.getBand() == -1 ? primaryCell.getBasicCellData().getBand()
                                            : primaryCell.getBand()));
                ...
                if (simData != null && simData.getPrimaryCell() != null) {
                    ...
                    if (networkGen == 4 && simData.getActiveCells().length > 0) {
                        if (simData.getActiveCells()[0] instanceof NrCellData)
                            networkGen++;
                    }
                    ...
                    latestCellSnapshots[simId] = new CellSnapshot(simData.getNetwork(),
                            ...
                            networkGen, simData.getPrimaryCell().getRawSignal(),
                            simData.getPrimaryCell().getRawSignalString(),
                            simData.getPrimaryCell().getProcessedSignal(),
                            simData.getPrimaryCell().getProcessedSignalString(),
                            simData.getPrimaryCell().getChannelNumber(),
                            simData.getPrimaryCell().getChannelNumberString(),
                            simData.getPrimaryCell().getStationIdentity(),
                            ...
                            simData.getPrimaryCell().getSignalNoise(), simData.getPrimaryCell().getSignalNoiseString(),
                            simData.getPrimaryCell().getTimingAdvance(),
